...
class QBitmap(QPixmap):
    ...
    @staticmethod
    def fromData(size: QtCore.QSize, bits: str, format: 'QImage.Format' = ...) -> 'QBitmap': ...
    @staticmethod
...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def __init__(self, data: str, width: int, height: int, format: 'QImage.Format') -> None: ...
    @typing.overload
    def __init__(self, data: sip.voidptr, width: int, height: int, format: 'QImage.Format') -> None: ...
    @typing.overload
    def __init__(self, data: str, width: int, height: int, bytesPerLine: int, format: 'QImage.Format') -> None: ...
    @typing.overload
...
class QPainterPath(sip.simplewrapper):
    ...
    def toSubpathPolygons(self, matrix: 'QTransform') -> typing.Any: ...
...
class QSurfaceFormat(sip.simplewrapper):
    ...
    @typing.overload
    def testOption(self, opt: 'QSurfaceFormat.FormatOptions') -> bool: ...
    @typing.overload
    def testOption(self, option: 'QSurfaceFormat.FormatOption') -> bool: ...
    @typing.overload
    def setOption(self, opt: 'QSurfaceFormat.FormatOptions') -> None: ...
    @typing.overload
...
class QTouchDevice(sip.simplewrapper):
    ...
    def setCapabilities(self, caps: 'QTouchDevice.Capabilities') -> None: ...
