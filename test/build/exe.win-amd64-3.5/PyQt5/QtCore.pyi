...
class QResource(sip.simplewrapper):
    ...
    @staticmethod
    def unregisterResourceData(rccData: str, mapRoot: str = ...) -> bool: ...
    @staticmethod
    def unregisterResource(rccFileName: str, mapRoot: str = ...) -> bool: ...
    @staticmethod
    def registerResourceData(rccData: str, mapRoot: str = ...) -> bool: ...
    @staticmethod
...
class QUrl(sip.simplewrapper):
    ...
    def topLevelDomain(self, options: 'QUrl.ComponentFormattingOptions' = ...) -> str: ...
    ...
    def host(self, options: 'QUrl.ComponentFormattingOptions' = ...) -> str: ...
...
def qUnregisterResourceData(a0: int, a1: str, a2: str, a3: str) -> bool: ...
def qRegisterResourceData(a0: int, a1: str, a2: str, a3: str) -> bool: ...
