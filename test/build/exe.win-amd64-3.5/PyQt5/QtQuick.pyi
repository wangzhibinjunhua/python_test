...
class QSGAbstractRenderer(QtCore.QObject):
    ...
    def setClearMode(self, mode: 'QSGAbstractRenderer.ClearMode') -> None: ...
...
class QSGMaterialShader(sip.wrapper):
    ...
    def setShaderSourceFiles(self, type: QtGui.QOpenGLShader.ShaderType, sourceFiles: typing.Iterable[str]) -> None: ...
    def setShaderSourceFile(self, type: QtGui.QOpenGLShader.ShaderType, sourceFile: str) -> None: ...
