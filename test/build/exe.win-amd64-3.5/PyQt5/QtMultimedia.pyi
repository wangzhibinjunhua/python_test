...
class QCamera(QMediaObject):
    ...
    def captureModeChanged(self, a0: 'QCamera.CaptureModes') -> None: ...
    def stateChanged(self, a0: 'QCamera.State') -> None: ...
    @typing.overload
    def unlock(self) -> None: ...
    @typing.overload
    def unlock(self, locks: 'QCamera.LockTypes') -> None: ...
    @typing.overload
    def searchAndLock(self) -> None: ...
    @typing.overload
    def searchAndLock(self, locks: 'QCamera.LockTypes') -> None: ...
    def stop(self) -> None: ...
    def start(self) -> None: ...
    def unload(self) -> None: ...
    def load(self) -> None: ...
    def setCaptureMode(self, mode: 'QCamera.CaptureModes') -> None: ...
    @typing.overload
    ...
    def isCaptureModeSupported(self, mode: 'QCamera.CaptureModes') -> bool: ...
...
class QCameraExposure(QtCore.QObject):
    ...
    def setFlashMode(self, mode: 'QCameraExposure.FlashModes') -> None: ...
    ...
    def isFlashModeSupported(self, mode: 'QCameraExposure.FlashModes') -> bool: ...
...
class QCameraImageCapture(QtCore.QObject, QMediaBindableInterface):
    ...
    def captureDestinationChanged(self, a0: 'QCameraImageCapture.CaptureDestinations') -> None: ...
    ...
    def setCaptureDestination(self, destination: 'QCameraImageCapture.CaptureDestinations') -> None: ...
    def captureDestination(self) -> 'QCameraImageCapture.CaptureDestinations': ...
    def isCaptureDestinationSupported(self, destination: 'QCameraImageCapture.CaptureDestinations') -> bool: ...
