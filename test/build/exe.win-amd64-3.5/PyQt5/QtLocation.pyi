...
class QGeoRoutingManagerEngine(QtCore.QObject):
    ...
    def setSupportedManeuverDetails(self, maneuverDetails: QGeoRouteRequest.ManeuverDetails) -> None: ...
    def setSupportedSegmentDetails(self, segmentDetails: QGeoRouteRequest.SegmentDetails) -> None: ...
    def setSupportedRouteOptimizations(self, optimizations: QGeoRouteRequest.RouteOptimizations) -> None: ...
    def setSupportedFeatureWeights(self, featureWeights: QGeoRouteRequest.FeatureWeights) -> None: ...
    def setSupportedFeatureTypes(self, featureTypes: QGeoRouteRequest.FeatureTypes) -> None: ...
    def setSupportedTravelModes(self, travelModes: QGeoRouteRequest.TravelModes) -> None: ...
    def error(self, reply: QGeoRouteReply, error: QGeoRouteReply.Error, errorString: str = ...) -> None: ...
    def finished(self, reply: QGeoRouteReply) -> None: ...
    def measurementSystem(self) -> QtCore.QLocale.MeasurementSystem: ...
    def setMeasurementSystem(self, system: QtCore.QLocale.MeasurementSystem) -> None: ...
